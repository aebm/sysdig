...
const filtercheck_field_info sinsp_filter_check_mesos_fields[] =
{
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "marathon.app.name", "Marathon app name (can return more than one value, concatenated)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "marathon.app.id", "Marathon app id (can return more than one value, concatenated)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "marathon.app.label", "Marathon app label. E.g. 'marathon.app.label.foo' (can return more than one value, concatenated)."},
